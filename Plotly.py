...
# Bode Plot
fig_bode = go.Figure()
fig_bode.add_trace(go.Scatter(x=data["Freq"], y=data["Zreal"], mode='lines+markers', name='Zreal'))
fig_bode.add_trace(go.Scatter(x=data["Freq"], y=data["Zimag"], mode='lines+markers', name='Zimag'))
